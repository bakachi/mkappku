...
import './deskription/Fusarium_deskription.dart'; // Mengimpor file fusarium_description.dart

class DiseaseDetail extends StatelessWidget {
  const DiseaseDetail({super.key});
                          ...
                          return Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: const DecorationImage(
                                image: AssetImage(
                                    './assets/images/Fusarium_2.jpg'), // Ganti dengan gambar yang diinginkan
                                fit: BoxFit.cover,
                              ),
                            ),
                          );
