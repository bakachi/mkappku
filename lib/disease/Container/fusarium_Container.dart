...
import '../detail/fusarium_detail.dart';

class FusariumContainer extends StatelessWidget {
  const FusariumContainer({super.key});
      ...
      child: Row(
        ...
        children: [
          ClipRRect(
            ...
            child: Image.asset(
              './assets/images/Fusarium_2.jpg', // Path gambar pertama
              width: 100,
              height: 215,
              fit: BoxFit.cover,
            ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'Disebabkan oleh jamur Fusarium oxysporum f.sp. cubense ',
